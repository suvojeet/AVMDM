        ...
        if (partyRepository != null) {
            try {
                ...
                DoubleSummaryStatistics qs = all.stream()
                        ...
                        .summaryStatistics();
                long avgScore = qs.getCount() > 0 ? Math.round(qs.getAverage() * 100) : 0L;
                metrics.put("avgQualityScore", avgScore);
                ...
                List<Map<String, Object>> trend = monthly.entrySet().stream()
                        ...
                        .collect(Collectors.toList());
                metrics.put("qualityTrend", trend);
